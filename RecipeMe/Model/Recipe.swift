...
struct Recipe: Identifiable {
    ...
    //if excludingOptionalDirections is true then directions will include directions that are not optional
    //if false then directions will include optional and nonptional directions
    ...
    struct MainInformation {
        ...
        //creating an enum and cases for each case in category
...
struct Ingredient: RecipeComponent {
    ...
    init() {
        ...
        var description: String {
            ...
            switch unit {
                //if there are no units, the formatted name and quanity name are displayed depending on the quantity
            case .none:
